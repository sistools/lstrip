...
# File:     makefile
#
# Purpose:  Makefile for the lstrip project,
...
lstrip.o: lstrip.c lstrip.h
lstrip_test.o: lstrip_test.cpp lstrip.h
entry.o: entry.c lstrip.h
...
lstrip: entry.o lstrip.o

lstrip_test: lstrip_test.o lstrip.o
